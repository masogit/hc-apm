...
import { SocialPerson, ActionExitToApp, ActionHelp, CommunicationMessage } from 'material-ui/svg-icons';
  ...
  render() {
    ...
    const iconElementRight = (
      <IconMenu iconButtonElement={<IconButton><SocialPerson /></IconButton>} targetOrigin={{vertical: 'bottom', horizontal: 'left'}}>
          ...
          <MenuItem leftIcon={<CommunicationMessage />} primaryText="Send a message" insetChildren onTouchTap={messageSend.bind(this, 'Test send a global message!')}/>
